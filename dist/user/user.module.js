...
UserModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [
            ...
            controllers_1.EmailConfirmationController,
            controllers_1.UserProfilController
        ],
        providers: [
            services_1.UsersService,
            services_1.AuthService,
            strategies_1.AuthLocalStrategy,
            auth_jwt_strategy_1.AuthJwtStrategy,
            user_email_service_1.UserEmailService,
            guards_1.EmailConfirmedGuard
        ],
        exports: [services_1.UsersService, services_1.AuthService, auth_jwt_strategy_1.AuthJwtStrategy, jwt_1.JwtModule, user_email_service_1.UserEmailService, guards_1.EmailConfirmedGuard]
    })
], UserModule);
