module.exports={
    "Template":{
        "TemplateName":"Y-NKAP_CONFIRM_EMAIL_TEMPLATE",
        "SubjectPart":"Y-Nkap Email confirmation",
                                ...
                                <tr>
                                  <td class="v-container-padding-padding" style="
                                    ...
                                    <h1 class="v-text-align v-line-height v-font-size" style="
                                          ...
                                          font-size: 30px;
                                        ">
                                      <strong>Congratulations ! <br> You are almost there.</strong>
                                    </h1>
                                  </td>
                                </tr>
                              </tbody>
                                  ...
                                  <td class="v-container-padding-padding" style="
                                    ...
                                    <div class="v-text-align v-line-height" style="
                                      ...
                                      <p style="font-size: 14px; line-height: 140%">
                                        Dear {{userEmail}}, your merchant account has been created.
                                        To complete the process and access your dashboard,
                                        you must confirm your email address via the following button:
                                      </p>
                                    </div>
                                  </td>
                                </tr>
                                    ...
                                    <table width="100%" cellpadding="0" cellspacing="0" border="0">
                                      <tr>
                                        <td class="v-text-align" style="
                                              ...
                                              padding-left: 0px;
                                            " align="center">
                                          <img align="center" border="0" src="https://lh4.googleusercontent.com/xWL8immcVxnpEEAsw-TfH3LkryMNvSmeEt36ReMKwPWpg4ptssecAHh5q5PYxM7p1H4=w2400" alt="image" title="image"
                                            style="
                                                outline: none;
                                                text-decoration: none;
                                                -ms-interpolation-mode: bicubic;
                                ...
                                <tr>
                                  <td class="v-container-padding-padding" style="
                                    ...
                                    <div class="v-text-align" align="center">
                                      ...
                                      <a href="{{confirmationLink}}" target="_blank" class="v-button v-size-width" style="
                                        ...
                                        <span class="v-line-height v-padding" style="
                                            ...
                                            "><strong><span style="
                                                  font-size: 14px;
                                                  line-height: 16.8px;
                                                ">Confirm my email</span></strong></span>
                                      </a>
